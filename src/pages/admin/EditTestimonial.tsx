...
import { useGetTestimonialQuery, useUpdateTestimonialMutation } from '@/store/api/testimonialApi';
...
const EditTestimonial = () => {
  ...
  const { data: testimonialData, isLoading: isFetching } = useGetTestimonialQuery(id!);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateTestimonial({ id: id!, formData: submitFormData }).unwrap();
      ...
      <div className="min-h-screen bg-background pt-[64px] md:pt-[80px] p-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-2">Update student testimonial details</p>
          </div>
